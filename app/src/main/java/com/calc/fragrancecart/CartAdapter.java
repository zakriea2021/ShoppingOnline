...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.CartViewHolder> {
    ...
    public void onBindViewHolder(CartViewHolder holder, int position) {
       ...
       // String poster = "http://boombox.ng/images/fragrance/" + fragranceImage;
        //String poster =  "http://192.168.222.2/MyApii/Api.php/" + fragranceImage;
        //String poster =  "http://192.168.222.2/productes/json_fragrances.php/" + fragranceImage;
        String poster =  "http://192.168.222.2/productes/fragrances/images/uploadsimages/" + fragranceImage;
