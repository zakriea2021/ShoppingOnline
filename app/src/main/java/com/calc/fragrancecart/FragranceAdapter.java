...
import com.calc.fragrancecart.data.Fragrance;
import com.calc.fragrancecart.data.FragranceContract;

import static com.calc.fragrancecart.DetailActivity.FRAGRANCE_DESCRIPTION;
import static com.calc.fragrancecart.DetailActivity.FRAGRANCE_IMAGE;
import static com.calc.fragrancecart.DetailActivity.FRAGRANCE_NAME;
import static com.calc.fragrancecart.DetailActivity.FRAGRANCE_PRICE;
import static com.calc.fragrancecart.DetailActivity.FRAGRANCE_RATING;
...
public class FragranceAdapter extends RecyclerView.Adapter<FragranceAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        //String poster = "http://192.168.222.2/MyApii/Api.php/" + mImageUrl;
       // String poster = "http://192.168.222.2/productes/json_fragrances.php/" + mImageUrl;
        String poster = "http://192.168.222.2/productes/fragrances/images/uploadsimages/" + mImageUrl;
