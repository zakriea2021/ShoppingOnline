package com.calc.fragrancecart.data;
...
public class FragranceProvider extends ContentProvider {
    ...
    static {
       ...
       // sUriMatcher.addURI(FragranceContract.CONTENT_AUTHORITY, FragranceContract.PATH_FRAGRANCE + "http://192.168.222.2/productes/fragrances/json_fragrances.php/", FRAGRANCE_ID);
       // sUriMatcher.addURI(FragranceContract.CONTENT_AUTHORITY, FragranceContract.PATH_CART + "http://192.168.222.2/productes/fragrances/json_fragrances.php/", CART_ID);
