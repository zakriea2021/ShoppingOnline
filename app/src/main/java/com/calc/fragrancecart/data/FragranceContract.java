...
public class FragranceContract {
     ...
     * device.
     */
    public static final String CONTENT_AUTHORITY = "com.calc.fragrancecart";
    ...
    // public static final Uri BASE_CONTENT_URI = Uri.parse("content://http://192.168.222.2/productes/fragrances/json_fragrances.php/" + CONTENT_AUTHORITY);
